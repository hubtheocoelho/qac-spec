...
All four trailers are mandatory. Order is fixed: Agent, Mode, What, Why. No references to external artifacts (chat sessions, local files). Each trailer must be self-contained.
